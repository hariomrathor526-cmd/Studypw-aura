...
app.use('/', createProxyMiddleware({
    ...
    onProxyRes: function (proxyRes, req, res) {
        ...
        proxyRes.on('end', () => {
            ...
            try {
                // 1. Compression Handle Karo (Symbols hatane ke liye)
                if (encoding === 'gzip') {
